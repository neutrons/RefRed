...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.clocking_box = QtWidgets.QGroupBox(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.clocking_box.sizePolicy().hasHeightForWidth())
        self.clocking_box.setSizePolicy(sizePolicy)
        self.clocking_box.setObjectName(_fromUtf8("clocking_box"))
        self.verticalLayout_15 = QtWidgets.QVBoxLayout(self.clocking_box)
        self.verticalLayout_15.setObjectName(_fromUtf8("verticalLayout_15"))
        self.frame_6 = QtWidgets.QFrame(self.clocking_box)
        ...
        self.clock2 = QtWidgets.QSpinBox(self.frame_6)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.clock1.setObjectName(_fromUtf8("clock1"))
