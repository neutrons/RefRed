...
class MPLWidgetNoLog(QtWidgets.QWidget):
    cplot = None
    cbar = None
    ...
    def __init__(self, parent=None, with_toolbar=True, coordinates=False):
        ...
        if with_toolbar:
            self.toolbar = NavigationToolbarMine(self.canvas, self, with_logX=False, with_logY=False)
            self.toolbar.coordinates = coordinates
            self.vbox.addWidget(self.toolbar)
            self.toolbar.logtogy.connect(self.logtoggleylog)
        else:
            self.toolbar = None
