"""
    ...
    This code is only called to generate a reduction script, not to actually reduce the data.

    TODO: refactor this and the live_reduction_handler.py code so that we gather the options
          only in once place.
    TODO: It appears that only the export() method is used in this class, and that it's
          a copy of the LiveReductionHandler.export(). Most of this code is dead.
"""
