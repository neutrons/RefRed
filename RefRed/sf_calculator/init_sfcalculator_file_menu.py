...
class InitSFCalculatorFileMenu(object):
    ...
    def initSeparator(self):
        if self.list_files != ['','','','','']:
#            self.sf_gui.menuFile.addSeparator()
            self.sf_gui.menuFile.addSeparator()
    ...
    def initAction(self):
        ...
        #self.sf_gui.menuFile.addAction(_action1)
        self.sf_gui.menuFile.addAction(_action1)
        ...
        #self.sf_gui.menuFile.addAction(_action2)
        self.sf_gui.menuFile.addAction(_action2)
        ...
        self.sf_gui.menuFile.addAction(_action3)
        ...
        self.sf_gui.menuFile.addAction(_action4)
        ...
        self.sf_gui.menuFile.addAction(_action5)
        _action5 = QtGui.QAction('', self.sf_gui)
        _action5.triggered.connect(self.sf_gui.launchConfigFile5)
        _action5.setShortcut(QtGui.QKeySequence(QtCore.Qt.META + QtCore.Qt.Key_4))
        _action5.setCheckable(True)
        ...
        self.sf_gui.menuFile.addAction(_action6)
        ...
        self.sf_gui.menuFile.addAction(_action7)
        ...
        self.sf_gui.menuFile.addAction(_action8)
        ...
        self.sf_gui.menuFile.addAction(_action9)
        ...
        self.sf_gui.menuFile.addAction(_action10)
    ...
    def	initGui(self):
        ...
        for i in range(len(_list_files)):
            ...
            if _file != '':
                ...
                self.sf_gui.menuFile.addAction(self.sf_gui.list_action[i])
