...
gp_template_3D="""#!/usr/bin/gnuplot
# Gnuplot script automatically generated by QuickNXS.
# Can be used to create plots of exported datasets.
# 
set term png enhanced size %(pix_x)i,%(pix_y)i font "DejaVuSans,24" lw 2
...
gp_line='"%(file_name)s" u 1:2:3 w errorlines t "(%(channel)s)" lw 1.5 pt 7 ps 0.25'
...
# %(column_names)s
'''
FILE_HEADER_PARAMS='%(scale)-12g %(P0)-3i %(PN)-5i %(x_pos)-8g %(x_width)-12g %(y_pos)-8g %(y_width)-12g %(bg_pos)-8g %(bg_width)-12g %(dpix)-12g %(tth)-12g %(file_number)-12s %(norm_index)-9s %(extract_fan)-4i %(file_name)-12s '
