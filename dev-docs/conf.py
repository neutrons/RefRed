...
# -*- coding: utf-8 -*-
#
# refred documentation build configuration file, created by
...
version = RefRed.__version__
# The full version, including alpha/beta/rc tags.
release = RefRed.__version__
...
latex_documents = [
    ('index', 'refred.tex',
     ...
     u'ORNL - Software Engineering Group', 'manual'),
]
...
man_pages = [
    ('index', 'refred',
     u'RefRed Developers Documentation',
     [u'ORNL - Software Engineering Group'], 1)
]
